...
export async function completeReservationForAdmin(reservationId, amountSpent, paymentMethod) {
...
export async function markReservationNoShowForAdmin(reservationId) {
