...
import { Box, Button, Card, CardContent, Container, Stack, TextField, Typography, FormControl, InputLabel, Select, MenuItem, } from "@mui/material";
...
export default function ReservationPaymentPage() {
    ...
    return (_jsx(Box, { sx: { minHeight: "100vh", background: "#f6f6f6", py: 6 }, children: _jsx(Container, { maxWidth: "sm", children: _jsx(Card, { sx: { borderRadius: 4 }, children: _jsx(CardContent, { children: _jsxs(Stack, { spacing: 3, children: [_jsx(Typography, { variant: "h3", sx: { fontWeight: 800 }, children: "Holding Fee Required" }), _jsx(Typography, { children: "This reservation falls on a high-traffic date and requires a holding fee." }), _jsxs(Typography, { sx: { fontWeight: 700 }, children: ["No-shows may be charged a minimum $", holdingFeeAmount, " holding fee."] }), _jsx(Typography, { sx: { color: "#64748b" }, children: "Enter your card details to authorize the holding fee." }), _jsx(TextField, { label: "Card Number", value: cardNumber, onChange: (e) => setCardNumber(e.target.value), fullWidth: true, slotProps: {
                                    htmlInput: {
                                        inputMode: "numeric",
                                        maxLength: 19,
                                    },
                                } }), _jsxs(FormControl, { fullWidth: true, children: [_jsx(InputLabel, { children: "Card Type" }), _jsx(Select, { value: cardType, label: "Card Type", onChange: (e) => setCardType(e.target.value), children: CARD_TYPES.map((type) => (_jsx(MenuItem, { value: type, children: type }, type))) })] }), _jsx(TextField, { label: "Expiry (MM/YY)", placeholder: "12/28", value: expiry, onChange: (e) => setExpiry(e.target.value), fullWidth: true, slotProps: {
                                    htmlInput: {
                                        maxLength: 5,
                                    },
                                } }), _jsx(Button, { variant: "contained", size: "large", disabled: isAuthorizing, onClick: handleAuthorizeHoldingFee, children: isAuthorizing ? "Authorizing..." : "Authorize Holding Fee" }), paymentError && (_jsx(Typography, { color: "error", children: paymentError })), _jsx(Button, { variant: "outlined", onClick: () => navigate("/reservation"), children: "Back to Reservation Search" })] }) }) }) }) }));
}
