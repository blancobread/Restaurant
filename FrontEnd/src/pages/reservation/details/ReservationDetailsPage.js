...
export default function ReservationDetailsPage() {
  ...
  if (!selectedTable) {
    return _jsx(Container, {
      children: _jsx(Typography, { children: "No table selected. Go back." }),
    });
  }
  return _jsx(Box, {
              ...
              children: _jsxs(Stack, {
                ...
                children: [
                  ...
                  _jsx(Button, {
                    ...
                    children: isSubmitting ? "Creating Reservation..." : "Continue",
                  }),
                  submitError ? _jsx(Typography, { color: "error", children: submitError }) : null,
                ],
              }),
            }),
          }),
